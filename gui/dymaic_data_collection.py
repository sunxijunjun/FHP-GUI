...
class PostureDataCollection(tk.Tk):
    ...
    def init_ui(self):
        instruction = (
            ...
            "1. Slowly lean forwards to the monitor\n"
            "2. Slowly lean backwards from the monitor\n"
            "3. Slowly tilt your body to the left\n"
            "4. Slowly tilt your body to the right\n"
            "5. Slowly tilt your head to the left\n"
            "6. Slowly tilt your head to the right\n"
            "7. Slowly turn your head to the left\n"
            "8. Slowly turn your head to the right\n"
            "9. Slowly rotate to the left side\n"
            "10. Slowly rotate to the right side\n"
    ...
    def on_start(self):
        postures = [
            "Slowly lean forwards to the monitor",
            "Slowly lean backwards from the monitor",
            "Slowly tilt your body to the left",
            "Slowly tilt your body to the right",
            "Slowly tilt your head to the left",
            "Slowly tilt your head to the right",
            "Slowly turn your head to the left",
            "Slowly turn your head to the right",
            "Slowly rotate to the left side",
            "Slowly rotate to the right side"

        ]
        data = []

        for posture in postures:
            messagebox.showinfo("Instruction", f"Please : {posture} and stay for 10 seconds.")
            time.sleep(1)
